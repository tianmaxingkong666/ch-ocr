...
if __name__=='__main__':
    ...
    dataRoot    = '/opt/chineseocr/train/data/text/ICDR2019/' ##icdr 数据所在目录
    darknetRoot = '/opt/chineseocr/darknet' ##darknet目录
    wP          = '/opt/chineseocr/models/text.weights' ##darknet 预训练模型权重
